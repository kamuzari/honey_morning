...
public class GlobalExceptionHandler {
	...
	public ErrorResponse handleAuthenticationExceptions(AuthenticationException exception) {
		...
		return ErrorResponse.builder(exception, INTERNAL_SERVER_ERROR, "")
	...
	public ErrorResponse handleBatchExceptions(ReadyAlramBatchException exception) {
		...
		ErrorProtocol errorProtocol = exception.getErrorProtocol();
		return ErrorResponse.builder(exception, INTERNAL_SERVER_ERROR, "배치 작업 중 오류가 발생했습니다.")
	...
	public ResponseEntity<String> handleAmqpException(AmqpException ex) {
		return new ResponseEntity<>(ex.getMessage(), NOT_IMPLEMENTED);
	}
}
