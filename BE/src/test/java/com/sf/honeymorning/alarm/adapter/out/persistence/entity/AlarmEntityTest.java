...
class AlarmEntityTest {
	...
	void testInitalize() {
		//given
		//when
		AlarmEntity alarmEntity = AlarmEntity.initialize(DATE_GENERATOR.number().randomNumber());
		//then
	...
	void testUpdate() {
		//given
		AlarmEntity existedAlarmEntity = AlarmEntity.initialize(DATE_GENERATOR.number().randomNumber());
