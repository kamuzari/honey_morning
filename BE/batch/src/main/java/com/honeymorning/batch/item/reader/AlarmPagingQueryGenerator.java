package com.honeymorning.batch.item.reader;

import static com.honeymorning.batch.item.reader.AlarmPagingQueryGenerator.AlarmPagingQuery.FROM;
import static com.honeymorning.batch.item.reader.AlarmPagingQueryGenerator.AlarmPagingQuery.GROUP;
import static com.honeymorning.batch.item.reader.AlarmPagingQueryGenerator.AlarmPagingQuery.SELECT;
import static com.honeymorning.batch.item.reader.AlarmPagingQueryGenerator.AlarmPagingQuery.SORT;
import static com.honeymorning.batch.item.reader.AlarmPagingQueryGenerator.AlarmPagingQuery.WHERE;
