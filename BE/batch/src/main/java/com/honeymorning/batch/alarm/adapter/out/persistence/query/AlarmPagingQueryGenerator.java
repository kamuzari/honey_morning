...
import static com.honeymorning.batch.alarm.adapter.out.persistence.query.AlarmPagingQueryGenerator.AlarmPagingQuery.FROM;
import static com.honeymorning.batch.alarm.adapter.out.persistence.query.AlarmPagingQueryGenerator.AlarmPagingQuery.GROUP;
import static com.honeymorning.batch.alarm.adapter.out.persistence.query.AlarmPagingQueryGenerator.AlarmPagingQuery.SELECT;
import static com.honeymorning.batch.alarm.adapter.out.persistence.query.AlarmPagingQueryGenerator.AlarmPagingQuery.SORT;
import static com.honeymorning.batch.alarm.adapter.out.persistence.query.AlarmPagingQueryGenerator.AlarmPagingQuery.WHERE;
